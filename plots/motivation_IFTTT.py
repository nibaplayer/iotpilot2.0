...
# 读取遗传算法数据
file_path_genetic = "/home/hao/code/iotpilot2.0/src/results/motion_sensor_80/genetic/generation_2.json"
...
for individual_key in data_genetic.keys():
    individual = data_genetic[individual_key]["motion_sensor_80"]
...
# 读取chatiot数据
file_path_chatiot = "/home/hao/code/iotpilot2.0/src/results/motion_sensor_80/chatiot/1/workflow_results.json"
with open(file_path_chatiot, "r") as file:
    data_chatiot = json.load(file)

# 读取iotpilot数据
file_path_chatiot = "/home/hao/code/iotpilot2.0/src/results/motion_sensor_80/IoTPilot/1/workflow_results.json"
with open(file_path_chatiot, "r") as file:
    IoTPilot_IoTPilot = json.load(file)

# 提取 chatiot 数据
motion_data = data_chatiot["motion_sensor_80"]
...
# 提取 IoTPilot 数据
motion_data_iotpilot = IoTPilot_IoTPilot["motion_sensor_80"]
...
plt.tight_layout()
plt.savefig('motivation_ifttt.pdf', dpi=1000, bbox_inches='tight')